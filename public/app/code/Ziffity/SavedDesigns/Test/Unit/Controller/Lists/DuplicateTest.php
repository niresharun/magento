...
use Ziffity\SavedDesigns\Controller\Lists\Duplicate;
...
class DuplicateTest  extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->duplicateController = new Duplicate(
            $this->requestMock,
    ...
    /**
     * @covers \Ziffity\SavedDesigns\Controller\lists\Duplicate::execute
     * @return void
     */
    public function testExecute()
    {
        ...
        $this->assertEquals($this->resultJsonMock, $this->duplicateController->execute());
    }
}
