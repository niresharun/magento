...
namespace Ziffity\Shipping\Test\Unit\Ui\Component\OversizeProfile\Listing\Column;

use Magento\Framework\View\Element\UiComponent\ContextInterface;
use PHPUnit\Framework\TestCase;
use Ziffity\Shipping\Ui\Component\OversizeProfile\Listing\Column\OversizeProfileActions;
...
class TestOversizeProfileActions extends TestCase
{
    ...
    public function testPrepareDataSource($expected, $data)
    {
        ...
        $listingInstance = new OversizeProfileActions($contextMock, $uiComponentFactoryMock, $urlMock);
    ...
    public function decodedDataSource()
    {
        ...
        "profile_id":"6","profile_name":"Custom Oversize profile creation",
