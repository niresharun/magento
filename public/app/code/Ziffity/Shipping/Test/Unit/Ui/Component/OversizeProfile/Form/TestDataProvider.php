...
namespace Ziffity\Shipping\Test\Unit\Ui\Component\OversizeProfile\Form;

use Magento\Framework\App\RequestInterface;
use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;
use PHPUnit\Framework\TestCase;
use Ziffity\Shipping\Ui\Component\OversizeProfile\Form\DataProvider;
...
class TestDataProvider extends TestCase
{
     ...
     * @covers \Ziffity\Shipping\Ui\Component\OversizeProfile\Form\DataProvider::getData
        ...
        return [
            ['expected'=>["1"=>["profile_id"=>"1",
                ...
                "dynamic_rows"=>["0"=>["charge_id"=>"1",
                    "profile_id"=>"1","united_inch_min"=>"1.0000",
                    "united_inch_max"=>"10.0000",
