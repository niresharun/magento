...
use Ziffity\Shipping\Controller\Adminhtml\Oversize\Profile\Add;
...
class TestAdd extends TestCase
{
    ...
    /**
     * @covers \Ziffity\Shipping\Controller\Adminhtml\Oversize\Profile\Add::execute
     * @return void
     */
    public function testExecute(): void
    {
        ...
        $resultRedirect->expects($this->any())->method('setPath')
            ->with('shipping/oversize_profile/edit')
            ->willReturnSelf();
