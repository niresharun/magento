...
use Ziffity\Shipping\Model\ShippingProfile\ResourceModel\ShippingProfile\Collection as CollectionModel;
...
use Ziffity\Shipping\Controller\Adminhtml\Shipping\Profile\MassDelete;
...
class TestMassDelete extends TestCase
{
     ...
     * @covers \Ziffity\Shipping\Controller\Adminhtml\Shipping\Profile\MassDelete::execute
     * @return void
     */
    public function testExecute($collectionSize): void
    {
        ...
        $this->requestMock->expects($this->any())
            ->method('getParams')->willReturn(
                [
                    'namespace' => 'shipping_profile_listing',
                    'exclude' => true,
