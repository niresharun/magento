...
use Ziffity\Shipping\Controller\Adminhtml\Shipping\Profile\Save;
use Ziffity\Shipping\Model\ProfileCharge\ResourceModel\ProfileCharge\CollectionFactory as CollectionFactory;
...
class TestSave extends TestCase
{
     ...
     */
    private $shippingProfileResourceModel;

    /**
     * @var MockObject|SecondaryModel|(SecondaryModel&MockObject)
     */
    private $shippingProfileModel;
    ...
    public function setUp(): void
    {
        ...
        //shipping profile charge resource model mock object
        $this->shippingProfileResourceModel = $this->createMock(SecondaryResourceModel::class);
        //shipping profile charge model mock object
        $this->shippingProfileModel = $this->createMock(SecondaryModel::class);
        //shipping profile model mock object
        $this->shippingModel = $this->createMock(Model::class);
        //shipping profile resource model mock object
        $this->shippingResourceModel = $this->createMock(ResourceModel::class);
        //helper model mock object
        $this->helperMock = $this->createMock(Data::class);
        $this->controller = new Save(
            $this->contextMock,
            $this->shippingModel,
            $this->shippingResourceModel,
            $this->shippingProfileModel,
            $this->shippingProfileResourceModel,
    ...
    /**
     * @covers \Ziffity\Shipping\Controller\Adminhtml\Shipping\Profile\Save::execute
