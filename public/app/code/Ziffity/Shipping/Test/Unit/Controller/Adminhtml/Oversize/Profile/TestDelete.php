...
use Ziffity\Shipping\Model\OversizeProfile\OversizeProfile;
use Ziffity\Shipping\Model\OversizeProfile\OversizeProfileFactory as Model;
use Ziffity\Shipping\Controller\Adminhtml\Oversize\Profile\Delete;
...
class TestDelete extends TestCase
{
     ...
     * @covers \Ziffity\Shipping\Controller\Adminhtml\Oversize\Profile\Delete::execute
     * @return void
     */
    public function testExecute($profileId, $profileName): void
    {
        ...
        if ($profileId) {
            ...
            $model = $this->getMockBuilder(OversizeProfile::class)
                ->disableOriginalConstructor()
            ...
            $this->messageManagerMock->expects($this->any())
                ...
                ->with(__('Oversize Profile with %1 Deleted', $profileName));
        }
        if ($profileId == null) {
            $this->messageManagerMock->expects($this->any())
