...
namespace Ziffity\CustomFrame\Controller\Adminhtml\Product\Initialization\Helper\Plugin;
...
class CustomFrame
{
    ...
    public function afterInitialize(
        ...
        if (isset($this->request->getPost('co_product_options')['co_product_options'])) {
            foreach ($this->request->getPost('co_product_options')['co_product_options'] as $key => $option) {
            ...
            if ($result['bundle_selections'] && !$compositeReadonly) {
                ...
                array_push($bundleSelections, $result['bundle_selections'][0]);
            ...
            if ($result['bundle_options'] && !$compositeReadonly) {
                ...
                array_push($bundleOptions, $result['bundle_options'][0]);
