...
class Glass extends \Ziffity\ProductCustomizer\Model\Components\Pricing\AbstractPrice
{
    /**
     * @param Helper $helper
    ...
    {
        $initialPrice = $this->processRule->applyPrimary($product, $selectionData, 'glass_type');
