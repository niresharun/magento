define([
...
], function ($, _, ko, priceUtils, filterUtils, AbstractOption, stepNavigator, performAjax, customizerDataResolver) {
    'use strict';
    ...
    return AbstractOption.extend({
        defaults: {
            ...
            defaultSelection: window.customizerConfig.options.cork_board.active_item,
            optionId: window.customizerConfig.options.cork_board.active_item.option_id,
            ...
            exports: {
                productSelection: '${ $.provider }:options.cork_board.active_item',
                optionId: '${ $.provider }:options.cork_board.option_id',
                pricing: '${ $.provider }:price.cork_board',
        ...
        initSelection: function() {
            var self = this;
            self.productSelection(customizerDataResolver.resolveCorkboardSelection());
        },
        ...
        loadProductListIntoObservable:function() {
            ...
            result.done(function(response){
                if (response!==undefined && response.products !== undefined) {
                    ...
                    if (response.product_total_count.corkboards!==undefined) {
                        self.productListCount(response.product_total_count.corkboards);
