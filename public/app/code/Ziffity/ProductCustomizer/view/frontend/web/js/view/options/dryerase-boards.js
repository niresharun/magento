define([
    ...
    'text!Ziffity_ProductCustomizer/template/optioninfo/dryerase-board-info.html',
], function ($, _, ko, priceUtils, filterUtils, AbstractOption, stepNavigator, performAjax, customizerDataResolver, info) {
    'use strict';
    ...
    return AbstractOption.extend({
        defaults: {
            ...
            defaultSelection: window.customizerConfig.options.dryerase_board.active_item,
            optionId: window.customizerConfig.options.dryerase_board.active_item.option_id,
            ...
            exports: {
                productSelection: '${ $.provider }:options.dryerase_board.active_item',
                optionId: '${ $.provider }:options.dryerase_board.option_id',
                pricing: '${ $.provider }:price.dryerase_board',
        ...
        initSelection: function() {
            var self = this;
            self.productSelection(customizerDataResolver.resolveDryeraseboardSelection());
        },
        ...
        loadProductListIntoObservable:function() {
            ...
            result.done(function(response){
                if (response!==undefined && response.products !== undefined) {
                    ...
                    if (response.product_total_count.dryerase_board!==undefined) {
                        self.productListCount(response.product_total_count.dryerase_board);
