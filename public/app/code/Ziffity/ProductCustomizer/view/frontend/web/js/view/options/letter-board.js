define([
    ...
    'text!Ziffity_ProductCustomizer/template/optioninfo/letter-board-info.html',
    ...
    return AbstractOption.extend({
        defaults: {
            ...
            defaultSelection: window.customizerConfig.options.letter_board.active_item,
            optionId: window.customizerConfig.options.letter_board.active_item.option_id,
            ...
            exports: {
                productSelection: '${ $.provider }:options.letter_board.active_item',
                optionId: '${ $.provider }:options.letter_board.option_id',
            },
            listens:{
        ...
        initSelection: function() {
            var self = this;
            self.productSelection(customizerDataResolver.resolveLetterBoardSelection());
        },
        ...
        loadProductListIntoObservable:function() {
            ...
            result.done(function(response){
                if (response!==undefined && response.products !== undefined) {
                    ...
                    if (response.product_total_count.letter_board!==undefined) {
                        self.productListCount(response.product_total_count.letter_board);
